...
// C/C++ source code generated on : Fri Dec 30 17:29:33 2016
//
...
void robot_0ModelClass::step()
{
  ...
  if (varargout_1) {
    ...
    robot_B.Sum1 = (0.8 * robot_B.In1.Pose.Position.Y + 0.2 *
                    robot_B.In1_d.Pose.Position.Y) - robot_B.In1.Pose.Position.Y;
    ...
    robot_B.Sum = ((0.8 * robot_B.In1.Pose.Position.X +
                    robot_B.In1_d.Pose.Position.X * 0.2) + 0.30000000000000004)
...
void robot_0ModelClass::initialize()
{
  ...
  {
    static const char_T tmp[16] = { '/', 'r', 'o', 'b', 'o', 't', '_', '9', '/',
      'c', 'm', 'd', '_', 'v', 'e', 'l' };

    static const char_T tmp_0[11] = { '/', 'b', 'o', 't', '_', '0', '/', 'p',
      'o', 's', 'e' };

    static const char_T tmp_1[11] = { '/', 'b', 'o', 't', '_', '9', '/', 'p',
      'o', 's', 'e' };
