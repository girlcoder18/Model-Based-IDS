...
typedef struct {
  SL_Bus_robot_nav_msgs_Odometry In1;  // '<S16>/In1'
  SL_Bus_robot_nav_msgs_Odometry In1_d;// '<S15>/In1'
  SL_Bus_robot_nav_msgs_Odometry varargout_2;
...
struct P_robot_T_ {
  ...
  SL_Bus_robot_nav_msgs_Odometry Out1_Y0;// Computed Parameter: Out1_Y0
                                         //  Referenced by: '<S15>/Out1'

  SL_Bus_robot_nav_msgs_Odometry Constant_Value;// Computed Parameter: Constant_Value
                                                //  Referenced by: '<S13>/Constant'

  SL_Bus_robot_nav_msgs_Odometry Out1_Y0_p;// Computed Parameter: Out1_Y0_p
                                           //  Referenced by: '<S16>/Out1'

  SL_Bus_robot_nav_msgs_Odometry Constant_Value_m;// Computed Parameter: Constant_Value_m
