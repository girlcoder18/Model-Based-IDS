...
// C/C++ source code generated on : Wed Jan 25 17:05:22 2017
//
...
void robot_0ModelClass::step()
{
  ...
  robot_Conversion1(robot_B.In1.Pose.Pose.Orientation.X,
                    robot_B.In1.Pose.Pose.Orientation.Y,
                    robot_B.In1.Pose.Pose.Orientation.Z,
                    robot_B.In1.Pose.Pose.Orientation.W, &robot_B.sf_Conversion2);
  ...
  if (varargout_1) {
    ...
    robot_B.Sum1 = ((0.8 * robot_B.In1.Pose.Pose.Position.Y + 0.2 *
                     robot_B.In1_d.Pose.Pose.Position.Y) - 0.2598) -
      robot_B.In1.Pose.Pose.Position.Y;
    ...
    robot_B.Sum = ((0.8 * robot_B.In1.Pose.Pose.Position.X +
                    robot_B.In1_d.Pose.Pose.Position.X * 0.2) -
                   0.15000000000000002) - robot_B.In1.Pose.Pose.Position.X;
  ...
  robot_Conversion1(robot_B.In1_d.Pose.Pose.Orientation.X,
                    robot_B.In1_d.Pose.Pose.Orientation.Y,
                    robot_B.In1_d.Pose.Pose.Orientation.Z,
                    robot_B.In1_d.Pose.Pose.Orientation.W,
                    &robot_B.sf_Conversion1);
}
