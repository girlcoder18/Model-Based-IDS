...
SimulinkSubscriber<nav_msgs::Odometry, SL_Bus_robot_nav_msgs_Odometry> Sub_robot_10;

// For Block robot/camera/Subscribe2
SimulinkSubscriber<nav_msgs::Odometry, SL_Bus_robot_nav_msgs_Odometry> Sub_robot_11;
