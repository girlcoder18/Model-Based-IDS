...
//
#include "robot_two.h"
#include "robot_two_private.h"
#define robot_two_MessageQueueLen      (105)
#define robot_two_MessageQueueLen_g    (1)
...
//    '<S3>/Conversion2'
//
void robot_two_Conversion1(real_T rtu_x, real_T rtu_y, real_T rtu_z, real_T
  rtu_w, B_Conversion1_robot_two_T *localB)
{
  real_T b_y;
  real_T q_idx_0;
  real_T q_idx_1;
...
void robot_0ModelClass::step()
{
  ...
  varargout_1 = Sub_robot_two_11.getLatestMessage(&robot_two_B.varargout_2);

  // Outputs for Enabled SubSystem: '<S14>/Enabled Subsystem' incorporates:
  //   EnablePort: '<S16>/Enable'

  if (varargout_1) {
    robot_two_B.In1 = robot_two_B.varargout_2;
  }
  ...
  varargout_1_0 = Sub_robot_two_10.getLatestMessage(&robot_two_B.varargout_2);

  // Outputs for Enabled SubSystem: '<S13>/Enabled Subsystem' incorporates:
  //   EnablePort: '<S15>/Enable'

  if (varargout_1_0) {
    robot_two_B.In1_d = robot_two_B.varargout_2;
  }
  ...
  robot_two_Conversion1(robot_two_B.In1.Pose.Pose.Orientation.X,
                        robot_two_B.In1.Pose.Pose.Orientation.Y,
                        robot_two_B.In1.Pose.Pose.Orientation.Z,
                        robot_two_B.In1.Pose.Pose.Orientation.W,
                        &robot_two_B.sf_Conversion2);
  ...
  if (varargout_1) {
    ...
    robot_two_B.Sum1 = ((0.8 * robot_two_B.In1.Pose.Pose.Position.Y + 0.2 *
                         robot_two_B.In1_d.Pose.Pose.Position.Y) - 0.2598) -
      robot_two_B.In1.Pose.Pose.Position.Y;
    ...
    robot_two_B.Sum = ((0.8 * robot_two_B.In1.Pose.Pose.Position.X +
                        robot_two_B.In1_d.Pose.Pose.Position.X * 0.2) -
                       0.15000000000000002) -
      robot_two_B.In1.Pose.Pose.Position.X;

    // Fcn: '<S9>/Distance1'
    robot_two_B.Sum3 = rt_powd_snf(robot_two_B.Sum, 2.0) + rt_powd_snf
      (robot_two_B.Sum1, 2.0);
    if (robot_two_B.Sum3 < 0.0) {
      robot_two_B.Sum3 = -sqrt(-robot_two_B.Sum3);
    } else {
      robot_two_B.Sum3 = sqrt(robot_two_B.Sum3);
    }
    ...
    if (robot_two_B.Sum3 <= robot_two_P.speedThreshold2_const) {
      robot_two_B.Switch1 = robot_two_P.Stop1_Value;
      robot_two_B.Sum1 = robot_two_P.Stop1_Value;
    } else {
      // Sum: '<S9>/Sum3' incorporates:
      //   Trigonometry: '<S9>/Desired Yaw'

      robot_two_B.Sum3 = rt_atan2d_snf(robot_two_B.Sum1, robot_two_B.Sum) -
        robot_two_B.sf_Conversion2.yaw;
      robot_two_B.Switch1 = rt_atan2d_snf(sin(robot_two_B.Sum3), cos
        (robot_two_B.Sum3));

      // Fcn: '<S9>/Distance3' incorporates:
      //   Fcn: '<S9>/Bound [-pi,pi]'

      robot_two_B.Sum1 *= 5.0;
      ...
      robot_two_B.Sum3 = rt_powd_snf(robot_two_B.Sum, 2.0) + rt_powd_snf
        (robot_two_B.Sum1, 2.0);
      if (robot_two_B.Sum3 < 0.0) {
        robot_two_B.Sum1 = -sqrt(-robot_two_B.Sum3);
      } else {
        robot_two_B.Sum1 = sqrt(robot_two_B.Sum3);
      }
    ...
    robot_two_B.BusAssignment1 = robot_two_P.Constant_Value_p;
    robot_two_B.BusAssignment1.Linear.X = robot_two_P.LinearVelocitySlider_gain *
      robot_two_B.Sum1;
    robot_two_B.BusAssignment1.Angular.Z = robot_two_B.Switch1;

    // Outputs for Atomic SubSystem: '<S5>/Publish2'
    // Start for MATLABSystem: '<S8>/SinkBlock' incorporates:
    //   MATLABSystem: '<S8>/SinkBlock'

    Pub_robot_two_75.publish(&robot_two_B.BusAssignment1);
  ...
  robot_two_Conversion1(robot_two_B.In1_d.Pose.Pose.Orientation.X,
                        robot_two_B.In1_d.Pose.Pose.Orientation.Y,
                        robot_two_B.In1_d.Pose.Pose.Orientation.Z,
                        robot_two_B.In1_d.Pose.Pose.Orientation.W,
                        &robot_two_B.sf_Conversion1);
}
...
void robot_0ModelClass::initialize()
{
  ...
  rtmSetErrorStatus((&robot_two_M), (NULL));

  // block I/O
  (void) memset(((void *) &robot_two_B), 0,
                sizeof(B_robot_two_T));

  // states (dwork)
  (void) memset((void *)&robot_two_DW, 0,
                sizeof(DW_robot_two_T));

  {
    static const char_T tmp[16] = { '/', 'r', 'o', 'b', 'o', 't', '_', '1', '/',
      'c', 'm', 'd', '_', 'v', 'e', 'l' };

    static const char_T tmp_0[13] = { '/', 'r', 'o', 'b', 'o', 't', '_', '3',
      '/', 'p', 'o', 's', 'e' };

    static const char_T tmp_1[13] = { '/', 'r', 'o', 'b', 'o', 't', '_', '1',
      '/', 'p', 'o', 's', 'e' };
    ...
    robot_two_DW.obj_o.isInitialized = 0;
    robot_two_DW.obj_o.isInitialized = 1;
    for (i = 0; i < 13; i++) {
      tmp_3[i] = tmp_1[i];
    }

    tmp_3[13] = '\x00';
    Sub_robot_two_11.createSubscriber(tmp_3, robot_two_MessageQueueLen_g);
    ...
    robot_two_DW.obj_n.isInitialized = 0;
    robot_two_DW.obj_n.isInitialized = 1;
    for (i = 0; i < 13; i++) {
      tmp_3[i] = tmp_0[i];
    }

    tmp_3[13] = '\x00';
    Sub_robot_two_10.createSubscriber(tmp_3, robot_two_MessageQueueLen_g);
    ...
    robot_two_DW.obj.isInitialized = 0;
    robot_two_DW.obj.isInitialized = 1;
    for (i = 0; i < 16; i++) {
      tmp_2[i] = tmp[i];
    }

    tmp_2[16] = '\x00';
    Pub_robot_two_75.createPublisher(tmp_2, robot_two_MessageQueueLen);
    ...
    robot_two_B.In1 = robot_two_P.Out1_Y0_p;
    ...
    robot_two_B.In1_d = robot_two_P.Out1_Y0;
...
void robot_0ModelClass::terminate()
{
  ...
  if (robot_two_DW.obj_o.isInitialized == 1) {
    robot_two_DW.obj_o.isInitialized = 2;
  }
  ...
  if (robot_two_DW.obj_n.isInitialized == 1) {
    robot_two_DW.obj_n.isInitialized = 2;
  }
  ...
  if (robot_two_DW.obj.isInitialized == 1) {
    robot_two_DW.obj.isInitialized = 2;
  }
...
{
  static const P_robot_two_T robot_two_P_temp = {
...
RT_MODEL_robot_two_T * robot_0ModelClass::getRTM()
{
  return (&robot_two_M);
}
