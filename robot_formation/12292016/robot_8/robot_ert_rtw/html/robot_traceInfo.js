...
function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<S1>/robot_8_velocity"] = {sid: "robot:66"};
	this.sidHashMap["robot:66"] = {rtwname: "<S1>/robot_8_velocity"};
	this.rtwnameHashMap["<S1>/robot_8_angle"] = {sid: "robot:67"};
	this.sidHashMap["robot:67"] = {rtwname: "<S1>/robot_8_angle"};
	this.rtwnameHashMap["<S1>/enbale_robot_8"] = {sid: "robot:68"};
	this.sidHashMap["robot:68"] = {rtwname: "<S1>/enbale_robot_8"};
	...
	this.rtwnameHashMap["<S2>/robot_8_x_des"] = {sid: "robot:30"};
	this.sidHashMap["robot:30"] = {rtwname: "<S2>/robot_8_x_des"};
	this.rtwnameHashMap["<S2>/robot_8_y_des"] = {sid: "robot:31"};
	this.sidHashMap["robot:31"] = {rtwname: "<S2>/robot_8_y_des"};
	this.rtwnameHashMap["<S2>/robot_8_x_pos"] = {sid: "robot:32"};
	this.sidHashMap["robot:32"] = {rtwname: "<S2>/robot_8_x_pos"};
	this.rtwnameHashMap["<S2>/robot_8_y_pos"] = {sid: "robot:33"};
	this.sidHashMap["robot:33"] = {rtwname: "<S2>/robot_8_y_pos"};
	this.rtwnameHashMap["<S2>/robot_8_orient"] = {sid: "robot:34"};
	this.sidHashMap["robot:34"] = {rtwname: "<S2>/robot_8_orient"};
	...
	this.rtwnameHashMap["<S2>/robot_8_velocity"] = {sid: "robot:60"};
	this.sidHashMap["robot:60"] = {rtwname: "<S2>/robot_8_velocity"};
	this.rtwnameHashMap["<S2>/robot_8_angle"] = {sid: "robot:61"};
	this.sidHashMap["robot:61"] = {rtwname: "<S2>/robot_8_angle"};
	this.rtwnameHashMap["<S2>/enable_robot_8"] = {sid: "robot:62"};
	this.sidHashMap["robot:62"] = {rtwname: "<S2>/enable_robot_8"};
	...
	this.rtwnameHashMap["<S3>/robot_8_x_pos"] = {sid: "robot:18"};
	this.sidHashMap["robot:18"] = {rtwname: "<S3>/robot_8_x_pos"};
	this.rtwnameHashMap["<S3>/robot_8_y_pos"] = {sid: "robot:19"};
	this.sidHashMap["robot:19"] = {rtwname: "<S3>/robot_8_y_pos"};
	this.rtwnameHashMap["<S3>/robot_9_x_pos"] = {sid: "robot:26"};
	this.sidHashMap["robot:26"] = {rtwname: "<S3>/robot_9_x_pos"};
	this.rtwnameHashMap["<S3>/robot_9_y_pos"] = {sid: "robot:27"};
	this.sidHashMap["robot:27"] = {rtwname: "<S3>/robot_9_y_pos"};
	this.rtwnameHashMap["<S3>/robot_8_orient"] = {sid: "robot:22"};
	this.sidHashMap["robot:22"] = {rtwname: "<S3>/robot_8_orient"};
